...
```mermaid
flowchart TD
    Q1[What does the evidence show?] --> Q2[What might explain the pattern?]
    Q2 --> Q3[What is uncertain or missing?]
    Q3 --> Q4[Which actions are worth discussing?]
    Q4 --> Q5[Who must validate and decide?]
```

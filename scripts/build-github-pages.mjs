...
const discoveryRegistry = JSON.parse(await readFile(resolve(root, "seo/discovery-pages.json"), "utf8"));
...
const wikiHome = `${pages}wiki/`;
const logo = (href) => `<a class="wordmark" href="${href}"><img src="${pages}assets/favicon.svg" alt=""><span><b>Urban Heat</b><em>Democratization</em></span></a>`;
...
const guides = [
  {
    ...
    links: [
      ...
      ["Research wiki", wikiHome, "Read the full methods, equations, evidence, and governance field guide."],
...
const wikiArticles = [
  { slug: "civic-guide", title: "Civic Starter Guide", deck: "A plain-language route from a local heat question to a responsible next step—built for residents, educators, advocates, and public teams.", body: `<h2>Start with a decision, not a dashboard</h2><p>Bring one question a public group could act on: which routes, public spaces, or neighborhoods should we investigate first for cooling access during extreme heat? The platform can help make a pattern visible; it does not decide what a community needs.</p><h2>Use the workspace in four moves</h2><ol><li><strong>See the pattern:</strong> open a city and inspect the boundary, layers, and cooling-access context.</li><li><strong>Read the evidence label:</strong> identify the source, date, scale, and limitation before interpreting a result.</li><li><strong>Add local knowledge:</strong> ask people who know the place about shade timing, unsafe crossings, indoor conditions, maintenance, access, and missing places.</li><li><strong>Choose the next evidence step:</strong> a site visit, updated local data, accessible public meeting, technical review, or monitored pilot.</li></ol><div class="callout"><strong>A useful distinction:</strong> a derived map pattern is a prompt for local investigation—not a verdict about residents, a personal risk score, or a promise of cooling.</div><h2>Starting a new city</h2><p>On the Cities page, use a preconfigured city starter to fill the repeatable identity and study context. Then add a valid local boundary GeoJSON. Thermal layers, spectral overlays, costs, and local findings remain visibly unregistered until they are actually supplied and reviewed. This reduces setup work without turning a starter into a false claim of local evidence.</p><h2>End every meeting with five records</h2><p>Write down the question, evidence used, uncertainty, people who must review it, and next action. That small record makes the work easier to share, challenge, and improve.</p><p>For the maintained repository guide, read the <a href="${repoDocs}/12-civic-starter-guide.md">Civic Starter Guide</a>. Then open the <a href="${main}cities">Cities workspace</a> to begin.</p>` },
  { slug: "contact", title: "Collaborate & Contact", deck: "A clear, respectful path for communities, mentors, public partners, and researchers to help operationalize the work.", body: `<h2>Bring one clear question</h2><p>Urban Heat Democratization is an open invitation to make urban-heat decisions more understandable, testable, and humane. You do not need to be a graph-theory specialist to contribute. Start with a location, a public-interest question, and the evidence or lived context that deserves attention.</p><h2>Choose your doorway</h2><ul><li><strong>Community members and advocates:</strong> identify what a map misses, what a neighborhood needs, and what should be investigated locally.</li><li><strong>Mentors and reviewers:</strong> challenge theory, data provenance, uncertainty communication, sensitivity analysis, and evaluation design.</li><li><strong>Public partners:</strong> propose a bounded pilot with a local data steward, a decision owner, safeguards, and public learning plan.</li></ul><div class="callout"><strong>The working standard:</strong> open evidence, local wisdom, and accountable action. A contribution should make the work more legible, testable, equitable, or useful in the real world.</div><h2>Start the conversation</h2><p>Contact <a href="${config.contactUrl}">${esc(config.authorName)}</a>, open a <a href="${config.repositoryUrl}/issues">collaboration issue</a>, or use the <a href="${main}contact">canonical collaboration desk</a> for a simple step-by-step path.</p><h2>With gratitude</h2><p>With sincere appreciation for <strong>Mrs. Siddhi Shukla</strong>, Algebra Teacher and Math Chair at Pioneer Charter School of Science II in Saugus, MA, for nurturing mathematical curiosity and disciplined reasoning.</p><p>With deep gratitude to Aarti’s parents, <strong>Subasri Dorairaj</strong> and <strong>Ramanjanappa Ravikumar</strong>, for their encouragement, belief, and steadfast support behind this project.</p>` },
  { slug: "participate", title: "Help Operationalize the Work", deck: "An invitation to community members, mentors, public practitioners, and partners to make this research more locally truthful and accountable.", body: `<h2>Build this in public</h2><p>Urban Heat Democratization is ready for careful operational partnership—not uncritical adoption. Community members, mentors, public agencies, educators, researchers, designers, engineers, and local organizations can help turn an inspectable research workflow into a more useful civic tool.</p><h2>Useful ways to contribute</h2><ul><li><strong>Community members:</strong> test whether a map interpretation matches lived conditions; name missing places, barriers, and priorities.</li><li><strong>Mentors and researchers:</strong> stress-test assumptions, sensitivity, uncertainty, reproducibility, and evaluation design.</li><li><strong>Public practitioners:</strong> define a bounded pilot question and decision boundary with local data owners.</li><li><strong>Data and engineering partners:</strong> improve provenance, accessibility, privacy, and maintainable update workflows.</li></ul><div class="callout"><strong>Start small:</strong> choose one public-interest question, one bounded geography, local reviewers, and an accountable decision owner. State what the model may inform, what it cannot decide, and how people can challenge the result.</div><p>Read the complete <a href="${config.repositoryUrl}/blob/main/docs/wiki/11-community-and-mentor-invitation.md">community and mentor invitation</a>, open a <a href="${config.repositoryUrl}/issues">contribution issue</a>, or contact <a href="${config.contactUrl}">${esc(config.authorName)}</a>.</p>` },
  { slug: "repeatability", title: "Repeatability & Real-World Use", deck: "A clear distinction between what can be reproduced in code today and what must be validated before a public decision.", body: `<h2>Repeatability can be tested now</h2><p>The core includes a fixed reference test that runs the same weighted raster graph twice with identical inputs and random seeds. It requires the same spectral gap, sweep conductance, selected cut, percolation outputs, and sink-reliability estimate.</p><div class="equation">same inputs + same parameters + same seeds → same reported model output</div><h2>Field validity is a separate obligation</h2><p>Before operational use, validate local inputs; recompute across defensible adjacency, weight, sink, resolution, and masking choices; ground-truth candidate locations with field and community knowledge; then evaluate implemented actions with a pre-specified before/after comparison and uncertainty reporting.</p><div class="callout"><strong>The honest claim:</strong> this method is ready to support an auditable investigation workflow. It is not evidence by itself that a specific intervention will work in Boston or any other city.</div><p>Read the complete <a href="${config.repositoryUrl}/blob/main/docs/wiki/10-repeatability-and-real-world-validation.md">repeatability and real-world validation protocol</a> and the <a href="${main}">canonical platform</a>.</p>` },
  { slug: "theory-contract", title: "Spectral Theory Contract", deck: "What the graph mathematics establishes exactly, what it cannot establish, and the evidence required to cross that boundary.", body: `<h2>The object is a graph—not a city in full</h2><p>The model analyses an undirected weighted graph of valid raster cells. Its edge weights encode documented assumptions about local gradient barriers and optional greenness. The resulting mathematics is rigorous about that graph; it is not a direct measurement of heat transport, lived access, health risk, or intervention performance.</p><div class="equation">L = I − D⁻¹ᐟ²WD⁻¹ᐟ²   ;   φ(S) = cut(S,V∖S) / min(vol(S),vol(V∖S))</div><h2>What is guaranteed</h2><p>For a connected, nonnegative weighted graph, the implementation computes the second normalized-Laplacian eigenpair and evaluates threshold sets along the Fiedler-vector ordering. The selected set is the lowest-conductance <em>sweep cut</em>—a reproducible, inspectable candidate, not an exhaustive search over all subsets.</p><div class="equation">λ₂/2 ≤ φ* ≤ √(2λ₂)</div><p>Cheeger-type bounds explain why spectral connectivity and conductance are related. They do not validate the raster, weights, sink definition, or a causal theory of intervention.</p><h2>What requires evidence beyond the graph</h2><div class="callout"><strong>Before any public decision:</strong> test reasonable parameter choices, document sources and spatial support, seek field and domain review, incorporate community knowledge, and use a pre-specified evaluation design for outcome claims.</div><p>Read the complete <a href="${config.repositoryUrl}/blob/main/docs/wiki/09-spectral-theory-contract.md">Spectral Theory Contract</a>, then inspect the <a href="${main}">canonical platform</a> alongside its methods and caveats.</p>` },
  { slug: "worked-example", title: "A Practical Graph-Theory Example", deck: "Follow four map cells from a simple connection diagram to a careful, useful public question—without needing advanced mathematics.", body: `<figure class="process-figure"><img src="${pages}assets/cheeger-cut-walkthrough.svg" alt="Four-step diagram: four map cells become a weighted graph; A is selected as a cooling sink; a dashed Cheeger cut crosses the weak B-to-C edge; conductance is one ninth; the outcome is a question for local investigation."><figcaption>Read top to bottom: model cells, stated weights, inferred sink, candidate cut, then a careful public question.</figcaption></figure><h2>A tiny city map</h2><p>Imagine four equal map cells along a route to a shaded park. A is a candidate cooling sink. The numbers are relative <strong>conductances</strong>: larger means the model treats a connection as easier.</p><div class="equation">A (park) — 4 — B — 1 — C — 4 — D</div><p>The B–C link has weight 1; the outer links have weight 4. The number is not a temperature, distance, or judgement about people. It is one stated model assumption.</p><h2>Find the seam</h2><p>Put A and B on one side of a proposed split, <em>S={A,B}</em>. Only one edge crosses to the other side: B–C, with weight 1. The weighted degree volume on each side is 9, so the conductance is:</p><div class="equation">φ(S) = cut(S,V∖S) / min(vol(S),vol(V∖S)) = 1/9 ≈ 0.11</div><p>That small result says the halves are weakly connected <em>in this four-cell graph</em>. If the B–C connection were changed from 1 to 4, the result becomes <em>4/12 ≈ 0.33</em>: the seam is less pronounced.</p><h2>Translate math into a public question</h2><div class="callout"><strong>The right question:</strong> What conditions around this transition—canopy, shade timing, safe routes, public access, maintenance, or resident experience—might make cooling continuity difficult, and what local evidence would change that answer?</div><p>The graph does not say that a place is dangerous, that residents lack cooling, or that a project will deliver a stated temperature reduction. It shows why this connection deserves careful local investigation. Read the longer <a href="${config.repositoryUrl}/blob/main/docs/wiki/08-graph-theory-worked-example.md">repository worked example</a> or return to the <a href="${main}">canonical platform</a>.</p>` },
  { slug: "", title: "The Urban Heat Research Wiki", deck: "A rigorous, public-interest companion to the living urban-heat workspace: methods, equations, assumptions, and decision boundaries in one readable place.", body: `<div class="wiki-grid"><a class="wiki-card" href="${pages}wiki/math/"><p class="eyebrow">Mathematical foundations</p><h2>From a heat raster to a defensible graph</h2><p>Spatial fields, adjacency rules, Laplacians, conductance, effective resistance, uncertainty propagation, and validation logic.</p></a><a class="wiki-card" href="${pages}wiki/interpretation/"><p class="eyebrow">Scientific interpretation</p><h2>How to read a signal without mistaking it for a verdict</h2><p>What each layer can support, what it cannot, and the evidence needed before action.</p></a><a class="wiki-card" href="${pages}wiki/technical/"><p class="eyebrow">Reproducibility</p><h2>Trace every result to inputs, code, and tests</h2><p>Technical contracts, source modules, validation commands, and artifact provenance.</p></a><a class="wiki-card" href="${main}"><p class="eyebrow">Living workspace</p><h2>See the methods in public</h2><p>Return to the canonical platform to explore Boston evidence and transparent scenarios.</p></a></div>` },
  { slug: "math", title: "Mathematical Foundations", deck: "A careful, equation-level explanation of the spatial and network reasoning used to turn urban-heat evidence into inspectable questions.", body: `<h2>1. Start with a spatial field, not a story</h2><p>Let <em>T(x)</em> denote a temperature-related surface at location <em>x</em>. A raster observes cell summaries, not a continuous city: <em>yᵢ = Aᵢ[T] + εᵢ</em>, where <em>Aᵢ</em> represents the sensor, pixel footprint, resampling, masking, and retrieval choices, and <em>εᵢ</em> collects measurement and processing error. This distinction matters: a map value is a documented estimate, not a direct reading of every person’s exposure.</p><div class="equation">yᵢ = Aᵢ[T] + εᵢ   ;   E[εᵢ | xᵢ] = 0 is an assumption to test, not a guarantee.</div><h2>2. Construct a graph transparently</h2><p>Partition the study area into cells or features <em>V</em>. Create an edge <em>(i,j)</em> only when the chosen adjacency rule says the units are connected—rook, queen, distance radius, street network, or a documented hybrid. A nonnegative weight <em>wᵢⱼ</em> may express contiguity, similarity, or modeled cooling permeability. The degree is <em>dᵢ = Σⱼ wᵢⱼ</em>.</p><div class="equation">L = D − W   ;   Lᵣw = I − D⁻¹ᐟ² W D⁻¹ᐟ²</div><p>The graph Laplacian <em>L</em> formalizes smoothness. For any vector <em>f</em>, <em>fᵀLf = ½Σᵢⱼwᵢⱼ(fᵢ−fⱼ)²</em>. Large differences across strongly weighted edges cost more; that is a modeling statement about the edge definition, not an independent fact about the city.</p><h2>3. Locate structural bottlenecks</h2><p>For a subset <em>S</em>, conductance compares the edge boundary to the modeled volume on its smaller side. A small value identifies a weakly connected region in this particular graph.</p><div class="equation">φ(S) = cut(S,V∖S) / min(vol(S), vol(V∖S)),    vol(S)=Σᵢ∈S dᵢ</div><p>The second eigenvalue of the normalized Laplacian, <em>λ₂</em>, is related to the best conductance by Cheeger-type bounds: <em>λ₂/2 ≤ φ* ≤ √(2λ₂)</em>. These bounds give a principled reason to inspect a spectral partition; they do not prove that the area has the greatest lived heat burden or that one intervention is optimal.</p><h2>4. Model pathways with resistance</h2><p>With conductances collected in <em>L</em>, the effective resistance between nodes <em>a</em> and <em>b</em> is <em>Rₑff(a,b)=(eₐ−e_b)ᵀL⁺(eₐ−e_b)</em>, where <em>L⁺</em> is the Moore–Penrose pseudoinverse. It measures separation in the modeled network. If edge weights represent cooling connectivity, resistance is a useful friction proxy; if they do not, the same number has a different meaning.</p><div class="equation">Rₑff(a,b) = (eₐ − e_b)ᵀ L⁺ (eₐ − e_b)</div><h2>5. Make uncertainty travel with the result</h2><p>For a derived metric <em>g(y,θ)</em> with data <em>y</em> and modeling choices <em>θ</em>, local uncertainty can be approximated by the delta method: <em>Var[g] ≈ ∇gᵀΣ∇g</em>. In practice, rerunning across plausible resolutions, dates, thresholds, adjacency rules, and weights is often more honest than reporting false precision.</p><div class="equation">Var[g(y,θ)] ≈ ∇g(y,θ)ᵀ Σ ∇g(y,θ)</div><div class="callout"><strong>Decision rule:</strong> a pattern that changes materially under reasonable choices is a prompt for more evidence, not a ranking to operationalize.</div>` },
  { slug: "interpretation", title: "Interpretation & Responsible Use", deck: "The discipline of converting mathematical output into an accountable public question—without overclaiming.", body: `<h2>Evidence has a chain of custody</h2><p>Every claim should name the source, date, spatial support, retrieval or processing method, coverage gaps, and transformation. Separate the observation (what a layer records), the model output (what an algorithm computes), and the proposed action (what people decide). They are different kinds of statements with different burdens of proof.</p><h2>A practical inference ladder</h2><ol><li><strong>Observation:</strong> this supplied layer shows a spatial pattern under stated conditions.</li><li><strong>Analytical signal:</strong> this graph has a low-conductance partition under stated weights and adjacency.</li><li><strong>Hypothesis:</strong> local cooling access or exposure may deserve investigation here.</li><li><strong>Decision:</strong> a public body chooses action after local validation, feasibility, equity, engineering, and community review.</li></ol><h2>What validation looks like</h2><p>Triangulate with field observations, resident knowledge, public-health and emergency data where lawful and appropriate, shade and tree condition, housing and indoor conditions, mobility, maintenance, and local plans. Pre-register the question when possible; document disagreement; preserve the negative finding as well as the persuasive map.</p><div class="callout"><strong>Ethical boundary:</strong> no map or score should be used to infer an individual’s health status, deny a service, or substitute for consent and public process.</div><p>For the full repository record, consult the <a href="${repoDocs}/04-evidence-and-responsible-use.md">evidence and responsible-use guide</a>. Then return to the <a href="${main}">canonical Urban Heat platform</a> to inspect the living evidence beside its caveats.</p>` },
  { slug: "technical", title: "Technical Reference & Reproducibility", deck: "A direct route from public-facing claims to the code, inputs, contracts, and tests that make them auditable.", body: `<h2>Reproducibility is a public feature</h2><p>The scientific core separates graph, spectral, resistance, reliability, percolation, raster, and report workflows. The executable source is the implementation record; this wiki is the reading guide.</p><ul><li><a href="${config.repositoryUrl}/tree/main/core">Scientific core modules</a> define graph construction, spectral calculations, raster utilities, and reporting.</li><li><a href="${config.repositoryUrl}/tree/main/tests">Tests</a> capture numerical expectations and contract behavior.</li><li><a href="${config.repositoryUrl}/blob/main/docs/BOSTON_STUDY_GUIDE.md">Boston Study Guide</a> states the bundled-study meaning and limits.</li><li><a href="${config.repositoryUrl}/blob/main/docs/Urban_Thermal_Math_Deep_Dive.md">Urban Thermal Math Deep Dive</a> provides the extended mathematical companion.</li></ul><h2>Minimum reproducibility record</h2><p>For each release, preserve input identifiers and licenses, boundary version, CRS, raster resolution and dates, masks and exclusions, graph rule, edge weights, parameter values, software revision, random seed, test results, and a plain-language interpretation statement. A result that cannot be reconstructed cannot be meaningfully challenged—and cannot earn public trust.</p><p>Open the <a href="${main}">canonical platform</a> to see the methods made legible in the actual urban-heat experience.</p>` },
];

const generatedDiscoveryPaths = [
  ...guides.map((guide) => guide.slug ? `/${guide.slug}/` : "/"),
  ...wikiArticles.map((article) => article.slug ? `/wiki/${article.slug}/` : "/wiki/"),
].sort();
const registeredDiscoveryPaths = discoveryRegistry.githubPagesPages.map((page) => page.path).sort();
if (generatedDiscoveryPaths.join("\n") !== registeredDiscoveryPaths.join("\n")) {
...
function renderPage(page) {
  // The Pages guide is a discovery surface. The custom domain is the authoritative
  // public identity, so search engines and readers always return to it.
  const canonical = main;
...
const polish = `
:root{--night:#05283a;--teal:#08776f;--mint:#dff6ee;--sun:#efbc57;--paper:#f5f8f5;--display:Iowan Old Style,Palatino Linotype,Book Antiqua,Palatino,Georgia,serif}
body{background:radial-gradient(50rem 32rem at 8% -12%,#fff2ce 0,transparent 58%),radial-gradient(48rem 32rem at 96% 3%,#ccece3 0,transparent 54%),var(--paper);letter-spacing:.003em}
.site-header{position:sticky;top:0;z-index:5;max-width:none;padding:1rem clamp(1.25rem,5vw,5rem);border-color:rgba(9,89,89,.14);background:rgba(245,248,245,.86);backdrop-filter:blur(18px)}
.wordmark{display:inline-flex;align-items:center;gap:.7rem;color:var(--night);font-size:.85rem;letter-spacing:.035em}.wordmark img{width:2.25rem;height:2.25rem;filter:drop-shadow(0 6px 10px rgba(5,40,58,.16))}.wordmark span{display:grid;gap:.04rem;color:inherit}.wordmark b{color:var(--night);font-size:.82rem}.wordmark em{color:var(--teal);font-size:.68rem;font-style:normal;font-weight:800;letter-spacing:.09em;text-transform:uppercase}
nav{justify-content:center;gap:clamp(.55rem,1.1vw,1.1rem)}nav a{padding:.34rem .1rem;border-bottom:1px solid transparent;color:#426367;font-size:.72rem;letter-spacing:.025em;text-transform:none}nav a:hover,nav a[aria-current=page]{border-color:var(--sun);color:var(--night)}.header-cta{padding:.56rem .8rem;border:1px solid rgba(8,119,111,.22);border-radius:999px;background:#effaf6;color:#075f59;font-size:.76rem}
main{padding-top:clamp(2.6rem,6vw,6rem)}.hero{position:relative;min-height:35rem}.hero-copy{position:relative;z-index:1}.hero h1,.path h2,.resources h2,.article h1{font-family:var(--display);font-weight:600}.hero h1{max-width:12ch;color:var(--night);text-wrap:balance}.deck{color:#335459}.hero-visual:before{inset:-1.4rem 1.2rem 1.2rem -1.3rem;border-radius:1.6rem;background:linear-gradient(135deg,#f9d77c,#95ddcb 54%,#75bfe9)}.hero-visual img{border-radius:1.15rem;box-shadow:0 28px 70px rgba(5,40,58,.17)}.button{transition:transform .18s ease,box-shadow .18s ease}.button:hover{transform:translateY(-2px);box-shadow:0 12px 22px rgba(5,70,72,.15)}.button.primary{background:linear-gradient(135deg,#075f72,#08776f)}
.principle-card,.wiki-card{border-color:rgba(8,89,89,.14);border-radius:1.15rem;background:rgba(255,255,252,.8);box-shadow:0 12px 32px rgba(5,40,58,.045)}.principle-card{min-height:18rem}.principle-card h2{font-family:var(--display);color:var(--night)}.path{border:1px solid rgba(236,188,87,.28);border-radius:1.5rem;background:radial-gradient(42rem 20rem at 100% 0%,rgba(68,201,170,.25),transparent 60%),linear-gradient(135deg,#062e42,#075b60)}.resources{padding-top:1.5rem}.resource-link{border-radius:.8rem;padding:1rem;transition:background .18s ease,transform .18s ease}.resource-link:hover{transform:translateX(4px);background:rgba(223,246,238,.65)}
.article{max-width:58rem;padding:clamp(1.5rem,4vw,3rem);border:1px solid rgba(8,89,89,.12);border-radius:1.4rem;background:rgba(255,255,252,.76);box-shadow:0 18px 55px rgba(5,40,58,.06)}.article h1{max-width:14ch;margin-top:.25rem;color:var(--night)}.article h2{color:#123c40;font-family:var(--display);font-size:clamp(1.7rem,3vw,2.35rem)}.article h2::before{display:block;width:2.3rem;height:2px;margin:0 0 .75rem;background:linear-gradient(90deg,var(--sun),transparent);content:""}.article .deck{max-width:48rem}.wiki-hero{max-width:76rem;background:linear-gradient(135deg,rgba(255,255,252,.94),rgba(232,248,242,.72))}.wiki-grid{grid-template-columns:repeat(4,minmax(0,1fr))}.wiki-card{min-height:15rem}.wiki-card h2{font-family:var(--display);font-size:1.55rem;line-height:1.08}.equation{border-left-color:var(--sun);border-radius:.85rem;background:linear-gradient(135deg,#fff8df,#e8f7f1)}.callout{border-left:3px solid var(--teal);border-radius:.9rem;background:#edf8f3}footer{max-width:none;padding:2rem clamp(1.25rem,5vw,5rem);background:#052b3e;color:#e7f8f3;border:0}footer .wordmark b{color:#fff}footer .wordmark em{color:#9ee5d1}footer p,footer a{color:#bfe0d9}footer a:hover{color:#fff}
...
await copyFile(resolve(root, "web/public/favicon.svg"), resolve(out, "assets/favicon.svg"));

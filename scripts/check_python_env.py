...
def main() -> int:
    ...
    if version.major != SUPPORTED_MAJOR or version.minor != SUPPORTED_MINOR:
        ...
        print("- The scientific stack is pinned to versions tested against Python 3.11.")
        ...
        print("")
        print("Use a Python 3.11 interpreter and create the virtual environment with it.")
        print("Example:")

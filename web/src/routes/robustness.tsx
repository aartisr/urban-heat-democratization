...
export function RobustnessPage() {
  ...
  return <section className="page-stack robustness-page">
    <WorkflowHeader wide eyebrow="Interactive robustness lab" title="Change the assumptions. Watch the modeled network respond." description={data?.summary ?? "This laboratory uses a synthetic network to explain the project’s model mechanics. It is not a measured city outcome, a forecast, or an intervention guarantee."} />
